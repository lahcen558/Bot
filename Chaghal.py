...
print(f'     {W1}— {W2}— {W3}— {W4}— {W5}— {W6}— {W7}— {W8}— {W1}— {W2}— {W3}— {W4}— {W5}— {W6}— {W7}— {W8}— {W1}— {W2}— {W3}— {W4}— {W5}— {W6}— {W7}— {W8}—     ')
token = input(f"{W8} - Enter Token :  ")
print(f'     {W1}— {W2}— {W3}— {W4}— {W5}— {W6}— {W7}— {W8}— {W1}— {W2}— {W3}— {W4}— {W5}— {W6}— {W7}— {W8}— {W1}— {W2}— {W3}— {W4}— {W5}— {W6}— {W7}— {W8}—     ')
ID = input(f"{W8} - Enter Id : " )
print(f'     {W1}— {W2}— {W3}— {W4}— {W5}— {W6}— {W7}— {W8}— {W1}— {W2}— {W3}— {W4}— {W5}— {W6}— {W7}— {W8}— {W1}— {W2}— {W3}— {W4}— {W5}— {W6}— {W7}— {W8}—     ')
print(f' - Erorr - اشتراك في قناتي اولاا للتشغيل     - ')
time.sleep(2)
webbrowser.open('https://t.me/S_VD11')
time.sleep(4)
os.system('clear')
